...
<body>
	...
	<form id="form1">
		...
		<textarea name="content1" cols="100" rows="8" style="width:928.45px;height:280px;visibility:hidden;"><%=htmlspecialchars(htmlData)%></textarea>
		<br />
		<input type="button" onclick="publish()" name="button" class="btn btn-primary"
			value="发布文章" />
	</form>
</body>
